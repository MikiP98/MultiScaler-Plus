...
|:------------------------------------------------------------------------------------------------------------------:|:---------------------------------------------------------------------------------------------:|:-----------------------------------------------------------------------------------:|:---------------------------------------------------------------------------------:|
| ![Original](https://upload.wikimedia.org/wikipedia/commons/a/a6/160_by_160_thumbnail_of_%27Green_Sea_Shell%27.png) | ![Nearest Neighbour](src/example_images/output/example_shell_40px/CV2_INTER_NEAREST_example_shell_40px_4x.png) | ![Bilinear](src/example_images/output/example_shell_40px/CV2_INTER_LINEAR_example_shell_40px_4x.png) | ![Bicubic](src/example_images/output/example_shell_40px/CV2_INTER_CUBIC_example_shell_40px_4x.png) |

|                                       Lanczos                                        |                                  EDSR *(CV2)*                                   |                                   ESPCN *(CV2)*                                   |                                   FSRCNN *(CV2)*                                    |
|:------------------------------------------------------------------------------------:|:-------------------------------------------------------------------------------:|:---------------------------------------------------------------------------------:|:-----------------------------------------------------------------------------------:|
| ![Lanczos](src/example_images/output/example_shell_40px/CV2_INTER_LANCZOS4_example_shell_40px_4x.png) | ![EDSR *(CV2)*](src/example_images/output/example_shell_40px/CV2_EDSR_example_shell_40px_4x.png) | ![ESPCN *(CV2)*](src/example_images/output/example_shell_40px/CV2_ESPCN_example_shell_40px_4x.png) | ![FSRCNN *(CV2)*](src/example_images/output/example_shell_40px/CV2_FSRCNN_example_shell_40px_4x.png) |

|                                      FSRCNN-small *(CV2)*                                       |                                   LapSRN *(CV2)*                                    |                                 A2N *(SI)*                                  |                                    AWSRN-BAM *(SI)*                                     |
|:-----------------------------------------------------------------------------------------------:|:-----------------------------------------------------------------------------------:|:---------------------------------------------------------------------------:|:---------------------------------------------------------------------------------------:|
| ![FSRCNN-small *(CV2)*](src/example_images/output/example_shell_40px/CV2_FSRCNN_small_example_shell_40px_4x.png) | ![LapSRN *(CV2)*](src/example_images/output/example_shell_40px/CV2_LapSRN_example_shell_40px_4x.png) | ![A2N *(SI)*](src/example_images/output/example_shell_40px/SI_a2n_example_shell_40px_4x.png) | ![AWSRN-BAM *(SI)*](src/example_images/output/example_shell_40px/SI_awsrn_bam_example_shell_40px_4x.png) |

|                                  CARN *(SI)*                                  |                                    CARN-BAM *(SI)*                                    |                                  DRLN *(SI)*                                  |                                    DRLN-BAM *(SI)*                                    |
|:-----------------------------------------------------------------------------:|:-------------------------------------------------------------------------------------:|:-----------------------------------------------------------------------------:|:-------------------------------------------------------------------------------------:|
| ![CARN *(SI)*](src/example_images/output/example_shell_40px/SI_carn_example_shell_40px_4x.png) | ![CARN-BAM *(SI)*](src/example_images/output/example_shell_40px/SI_carn_bam_example_shell_40px_4x.png) | ![DRLN *(SI)*](src/example_images/output/example_shell_40px/SI_drln_example_shell_40px_4x.png) | ![DRLN-BAM *(SI)*](src/example_images/output/example_shell_40px/SI_drln_bam_example_shell_40px_4x.png) |

|                                  EDSR *(SI)*                                  |                                    EDSR-base *(SI)*                                     |                                 HAN *(SI)*                                  |                                  MDSR *(SI)*                                  |
|:-----------------------------------------------------------------------------:|:---------------------------------------------------------------------------------------:|:---------------------------------------------------------------------------:|:-----------------------------------------------------------------------------:|
| ![EDSR *(SI)*](src/example_images/output/example_shell_40px/SI_edsr_example_shell_40px_4x.png) | ![EDSR-base *(SI)*](src/example_images/output/example_shell_40px/SI_edsr_base_example_shell_40px_4x.png) | ![HAN *(SI)*](src/example_images/output/example_shell_40px/SI_han_example_shell_40px_4x.png) | ![MDSR *(SI)*](src/example_images/output/example_shell_40px/SI_mdsr_example_shell_40px_4x.png) |

|                                    MDSR-BAM *(SI)*                                    |                                  MSRN *(SI)*                                  |                                    MSRN-BAM *(SI)*                                    |                                 PAN *(SI)*                                  |
|:-------------------------------------------------------------------------------------:|:-----------------------------------------------------------------------------:|:-------------------------------------------------------------------------------------:|:---------------------------------------------------------------------------:|
| ![MDSR-BAM *(SI)*](src/example_images/output/example_shell_40px/SI_mdsr_bam_example_shell_40px_4x.png) | ![MSRN *(SI)*](src/example_images/output/example_shell_40px/SI_msrn_example_shell_40px_4x.png) | ![MSRN-BAM *(SI)*](src/example_images/output/example_shell_40px/SI_msrn_bam_example_shell_40px_4x.png) | ![PAN *(SI)*](src/example_images/output/example_shell_40px/SI_pan_example_shell_40px_4x.png) |

|                                   PAN-BAM *(SI)*                                    |                                    RCAN-BAM *(SI)*                                    |                                   RealESRGAN                                    |                                  Anime4K                                  |
|:-----------------------------------------------------------------------------------:|:-------------------------------------------------------------------------------------:|:-------------------------------------------------------------------------------:|:-------------------------------------------------------------------------:|
| ![PAN-BAM *(SI)*](src/example_images/output/example_shell_40px/SI_pan_bam_example_shell_40px_4x.png) | ![RCAN-BAM *(SI)*](src/example_images/output/example_shell_40px/SI_rcan_bam_example_shell_40px_4x.png) | ![RealESRGAN](src/example_images/output/example_shell_40px/RealESRGAN_example_shell_40px_4x.png) | ![Anime4K](src/example_images/output/example_shell_40px/Anime4K_example_shell_40px_4x.png) |

|                                  HSDBTRE                                  |                                hqx                                |                                NEDI <sup>*(m = 4)*</sup>                                 |                                   Super xBR                                   |
|:-------------------------------------------------------------------------:|:-----------------------------------------------------------------:|:----------------------------------------------------------------------------------------:|:-----------------------------------------------------------------------------:|
| ![HSDBTRE](src/example_images/output/example_shell_40px/HSDBTRE_example_shell_40px_4x.png) | ![hqx](src/example_images/output/example_shell_40px/hqx_example_shell_40px_4x.png) | ![NEDI <sup>*(m = 4)*</sup>](src/example_images/output/example_shell_40px/NEDI_example_shell_40px_4x.png) | ![Super xBR](src/example_images/output/example_shell_40px/Super_xBR_example_shell_40px_4x.png) |

|                                xBRZ                                 |                              FSR                               |                              CAS <sup>*(sharpness = 0.5)*</sup>                               |
|:-------------------------------------------------------------------:|:--------------------------------------------------------------:|:---------------------------------------------------------------------------------------------:|
| ![xBRZ](src/example_images/output/example_shell_40px/xBRZ_example_shell_40px_4x.png) | ![FSR](src/example_images/output/example_shell_40px/example_shell_40px_FSR.png) | ![CAS <sup>*(sharpness = 0.5)*</sup>](src/example_images/output/example_shell_40px/example_shell_40px_CAS.png) |
