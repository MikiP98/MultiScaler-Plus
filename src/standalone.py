...
# def thread_process(algorithm: Algorithms, path: str, scale,
        ...
        for file in files:
            ...
            if path.endswith(".png") or path.endswith(".jpg") or path.endswith(".jpeg"):
                ...
                for algorithm in algorithms:
                    for scale in scales:
                        # if (true_multithreading):
                        #     threads.append(Thread(target=thread_process, args=(algorithm, path, scale,
                        #                                                       add_algorithm_name_to_output_files_names,
                        #                                                       add_factor_to_output_files_names,
                        #                                                       sort_by_algorithm,
                        #                                                       lossless_compression)))
                        # else:
                        #     process_image(algorithm, path, scale,
                        #                   add_algorithm_name_to_output_files_names,
                        #                   add_factor_to_output_files_names,
                        #                   sort_by_algorithm,
                        #                   lossless_compression)

                        process_image(algorithm, root, file, scale,
                                      add_algorithm_name_to_output_files_names,
                                      add_factor_to_output_files_names,
                                      sort_by_algorithm,
                                      lossless_compression)
